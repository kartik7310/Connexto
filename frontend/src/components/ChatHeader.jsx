...
const ChatHeader = ({ user, isLoading, isOnline }) => {
    ...
    return (
        <div className="flex items-center gap-3 p-2 border-b border-gray-700 bg-gray-800/60 backdrop-blur-md rounded-t-2xl sticky top-0 z-10">
            <div className="flex cursor-pointer" onClick={() => navigate("/connections")}>
                <ArrowLeftIcon />
                Back
            </div>
